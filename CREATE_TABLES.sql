-- Simply QR Database Tables
-- Run this SQL directly on your MySQL database if Prisma migrations don't work

-- Use the correct database
USE s167824_bubbling;

-- Drop tables if they exist (CAREFUL - this deletes data!)
...
-- Add foreign keys
ALTER TABLE `QRCode`
ADD CONSTRAINT `QRCode_userId_fkey`
FOREIGN KEY (`userId`) REFERENCES `User`(`id`)
ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE `Scan`
ADD CONSTRAINT `Scan_qrCodeId_fkey`
